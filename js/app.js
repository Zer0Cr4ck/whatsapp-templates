...
btnSave.addEventListener("click", function () {
  // 💚  Capturar los elementos e insertarlos a mi arreglo
  ...
  const hashtagValue = inputHashtag.value.trim();
  const messageValue = inputMessage.value.trim();

  const newTemplate = new Template(titleValue, messageValue, hashtagValue);
